...
| 断点续跑：mock 截断下 6 片各 52 字节全部落库且闸 2 放行；二次续跑 map=0（分片未重算） | `ev:incomplete-v5` | `python -m pytest tests/test_distill_resume.py -q` （脚本 `tests/test_distill_resume.py`） |
...
| `distill-orphan-matrix` | `verified` | docs/evidence/distill-orphan-matrix.json | tests/perf/distill_orphan_matrix.py | `e389fdc` | 2026-09-12 |
| `distill-resume-reachability` | `verified` | docs/evidence/distill-resume-reachability.json | tests/perf/distill_resume_reachability.py | `e389fdc` | 2026-09-12 |
| `graphify-snapshot-2026-08-15` | `unverifiable` | — | — | `eb72a3bd` | 2026-08-15 |
| `incomplete-v5` | `verified` | docs/evidence/incomplete-v5.json | tests/test_distill_resume.py | `unknown(scratch)` | 2026-09-10 |
| `ownership-reachability` | `verified` | docs/evidence/ownership-reachability.json | tests/perf/raise_probe.py | `5bacc48` | 2026-09-12 |
| `ownership-reachability-nokey` | `verified` | docs/evidence/ownership-reachability-nokey.json | tests/perf/raise_probe.py | `5bacc48` | 2026-09-12 |
| `thinking-capfield` | `verified` | docs/evidence/thinking-capfield.json | tests/perf/capfield_probe.py | `5ba7b9e` | 2026-09-10 |
| `thinking-maplen-after` | `verified` | docs/evidence/thinking-maplen-after.json | tests/perf/map_len_probe.py | `bc19511` | 2026-09-10 |
| `thinking-maplen-before` | `verified` | docs/evidence/thinking-maplen-before.json | tests/perf/map_len_probe.py | `bc19511` | 2026-09-10 |
