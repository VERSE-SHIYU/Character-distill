...
def test_load_affinity_legacy_upgrade():
    ...
    engine = ChatEngine(
        ...
        session_id="legacy_upgrade", is_new_session=True, storage=MagicMock(),
    )
...
def test_load_affinity_uninitialized_computes_and_saves():
    ...
    engine = ChatEngine(
        _StubLLM(), None, card, card_id="t", user_role="角色B",
        session_id="test_sesh", is_new_session=True, storage=MagicMock(),
    )
...
def test_affinity_engine_roundtrip():
    ...
    engine = ChatEngine(
        _StubLLM(), None, card, card_id="t", user_role="角色B",
        session_id="roundtrip_engine", is_new_session=True, storage=MagicMock(),
    )
