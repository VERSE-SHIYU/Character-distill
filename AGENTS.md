...
> **全表状态口径（2026-09-15 现跑现数）**：1–40 共 40 条 —— **已修 31**（含 40：commit 一 `53bed63` + commit 二）/ **记账 4**（32、33、35、36）/ **记账待补 1**（30）/ **已裁定 1**（31）/ 其余 3 条（3 纵深防御、10 已移出「三之二」、37 证伪）。**待办 = 记账 + 记账待补 = 5**。
